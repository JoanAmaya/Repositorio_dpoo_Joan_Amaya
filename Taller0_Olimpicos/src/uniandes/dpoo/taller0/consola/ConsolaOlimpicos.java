...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consutar nombre de atleta");
	...
	/**
	 * Opcion agregada para el taller
	 */
	private void ejecutarNombreAtleta()
	{
		String atleta= input("Ingrese el nombre del atleta");
		String pais=calculadora.buscarpais(atleta);
		System.out.println("El país que representa el atleta "+atleta+" es: "+pais);
