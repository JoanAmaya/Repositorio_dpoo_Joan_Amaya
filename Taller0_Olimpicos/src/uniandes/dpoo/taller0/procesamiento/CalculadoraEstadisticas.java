...
public class CalculadoraEstadisticas
{
	...
	public String buscarpais(String nombreAtleta)
	{
		Atleta atletanew=buscarAtleta(nombreAtleta);
		Pais nuevopais=atletanew.darPais();
		String valor= nuevopais.darNombre();
		return valor;
